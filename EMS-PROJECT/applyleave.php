...
<html>
<head>
	<title>Apply Leave | Employee Panel | RS Corporation</title>
	<link rel="stylesheet" type="text/css" href="Mycss/styleapply.css">
</head>
<body bgcolor="#F0FFFF">
	
	<header>
		<nav>
			<h1>RS Corporation</h1>
			<ul id="navli">
				<li><a class="homeblack" href="eloginwel.php?id=<?php echo $id?>"">HOME</a></li>
				<li><a class="homeblack" href="changepassemp.php?id=<?php echo $id?>"">Change Password</a></li>
